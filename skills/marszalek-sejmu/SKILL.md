...
3. **First reading** — 5 party agents speak in order: CR, NC, AC, Liberty Front, SD
...
Seat counts: CR=157, NC=194, AC=65, Liberty Front=18, SD=26. Total=460.
...
| Party | Vote | Seats |
|-------|------|-------|
| CR | FOR/AGAINST/ABSTAIN | 157 |
| NC | FOR/AGAINST/ABSTAIN | 194 |
| AC | FOR/AGAINST/ABSTAIN | 65 |
| Liberty Front | FOR/AGAINST/ABSTAIN | 18 |
| SD | FOR/AGAINST/ABSTAIN | 26 |
...
Flag incoherent results (e.g., CR and Liberty Front both voting FOR on a progressive tax hike) with:
```
...
[CR, NC, AC, Liberty Front, SD positions]
