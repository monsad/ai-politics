...
3. **Five party agents** (CR, NC, AC, Liberty Front, SD) hold a first reading using the ministry findings, then a second reading with rebuttals.
...
- `skills/` — 25 Hermes Agent skills following the [Anthropic Agent Skills](https://agentskills.io/specification) spec
  ...
  - `party-cr/`, `party-nc/`, `party-ac/`, `party-lf/`, `party-sd/` — 5 party agents with their actual political profiles
