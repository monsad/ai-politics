...
const PARTY_COLORS: Record<string, string> = {
  KO: "bg-orange-100 border-orange-400 text-orange-900",
  PiS: "bg-blue-200 border-blue-500 text-blue-900",
  TD: "bg-yellow-100 border-yellow-400 text-yellow-900",
  Konfederacja: "bg-amber-900/10 border-amber-900 text-amber-950",
  Lewica: "bg-red-100 border-red-400 text-red-900",
